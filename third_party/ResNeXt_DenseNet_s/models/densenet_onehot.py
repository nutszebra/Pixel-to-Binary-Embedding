...
class DenseNetOnehot(nn.Module):
  """DenseNet main class."""

  def __init__(self, growth_rate, depth, reduction, n_classes, bottleneck, m=32):
    super(DenseNetOnehot, self).__init__()

    self.onehot = Onehot(m=m)
...
def densenet_onehot(growth_rate=24, depth=40, num_classes=10, m=32):
  model = DenseNetOnehot(growth_rate, depth, 1., num_classes, False, m=m)
  return model
