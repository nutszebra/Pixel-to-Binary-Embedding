...
class CifarResNeXt(nn.Module):
  ...
  def __init__(self, block, depth, cardinality, base_width, num_classes, m=32, beta=-1.0e-1):
...
def resnext29b(num_classes=10, cardinality=4, base_width=32, m=32, beta=1.0e-1):
  model = CifarResNeXt(ResNeXtBottleneck, 29, cardinality, base_width,
                       num_classes, m=m, beta=beta)
  return model
