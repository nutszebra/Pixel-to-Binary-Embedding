...
class CifarResNeXtOnehot(nn.Module):
  ...
  def __init__(self, block, depth, cardinality, base_width, num_classes, m=32):
    super(CifarResNeXtOnehot, self).__init__()
...
def resnext29_onehot(num_classes=10, cardinality=4, base_width=32, m=32):
  model = CifarResNeXtOnehot(ResNeXtBottleneck, 29, cardinality, base_width,
                       num_classes, m=m)
  return model
